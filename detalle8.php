...
<head>
  <title>Inversiones y Servicios Ydrogo</title>
   ...
   <link rel="stylesheet" href="css/detalles8.css">
...
<div class="container text-center">
  <h1>Modelos de Engrapadores</h1>
	<div class="row">
		<div class="col-md-4">
      <div class="fondo1-producto">
		<img src="imagenes/egrapador2.jpg" alt="">	
		  </div>
    </div>

    <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/egrapador3.jpg" alt=""> 
      </div>
    </div>

     <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/egrapador4.jpg" alt=""> 
      </div>
    </div>

    <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/egrapador5.jpg" alt=""> 
      </div>
    </div>
      ...
      <div class="fondo2-producto">
			<h2>ENGRAPADORES</h2>
			<h3>Presio:S/.12.00</h3>
			<p>Tenemos una lista variada de modelos y marcas de engrapador de la mejor calidad.  </p>
