...
<head>
  <title>Inversiones y Servicios Ydrogo</title>
   ...
   <link rel="stylesheet" href="css/detalles6.css">
...
<div class="container text-center">
  <h1>Modelos de Cuadernos</h1>
	<div class="row">
		<div class="col-md-4">
      <div class="fondo1-producto">
		<img src="imagenes/cuaderno2.jpg" alt="">	
		  </div>
    </div>

    <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/cuaderno3.jpg" alt=""> 
      </div>
    </div>

     <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/cuaderno4.jpg" alt=""> 
      </div>
    </div>

    <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/cuaderno5.jpg" alt=""> 
      </div>
    </div>

     <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/cuaderno6.jpg" alt=""> 
      </div>
    </div>
      ...
      <div class="fondo2-producto">
			...
			<p>Esta es nuestra galería de cuadernos, en donde usted podrá optar por el modelo que guste y comprar. </p>
