...
<head>
  <title>Inversiones y Servicios Ydrogo</title>
   ...
   <link rel="stylesheet" href="css/detalles9.css">
...
<div class="container text-center">
  <h1>Modelos de Tomatodos</h1>
	<div class="row">
		<div class="col-md-4">
      <div class="fondo1-producto">
		<img src="imagenes/tomatodo2.jpg" alt="">	
		  </div>
    </div>

    <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/tomatodo3.jpg" alt=""> 
      </div>
    </div>

     <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/tomatodo4.jpg" alt=""> 
      </div>
    </div>

    <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/tomatodo5.jpg" alt=""> 
      </div>
    </div>

     <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/tomatodo6.jpg" alt=""> 
      </div>
    </div>
      ...
      <div class="fondo2-producto">
			<h2>TOMATODOS</h2>
			<h3>Presio:S/.15.00</h3>
			<p>Aqui le mostramos nuestra galeria de tomatodos para que usted pueda elegir. </p>
