...
<div class="container text-center">
  <h1>Modelos de Gomas</h1>
	<div class="row">
		<div class="col-md-4">
      <div class="fondo1-producto">
		<img src="imagenes/goma2.jpg" alt="">	
		  </div>
    </div>

    <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/goma3.jpg" alt=""> 
      </div>
    </div>

     <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/goma4.jpg" alt=""> 
      </div>
    </div>

    <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/goma5.jpg" alt=""> 
      </div>
    </div>

     <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/goma6.jpg" alt=""> 
      </div>
    </div>
      ...
      <div class="fondo2-producto">
			<h2>GOMAS</h2>
			<h3>Presio:S/.7.00</h3>
			<p>En nuestra tiende tenemos las mejores gomas de calidad y aun precio económico. </p>
