...
<head>
  <title>Inversiones y Servicios Ydrogo</title>
   ...
   <link rel="stylesheet" href="css/detalles10.css">
...
<div class="container text-center">
  <h1>Modelos de Loncheras</h1>
	<div class="row">
		<div class="col-md-4">
      <div class="fondo1-producto">
		<img src="imagenes/lonchera2.jpg" alt="">	
		  </div>
    </div>

    <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/lonchera3.jpg" alt=""> 
      </div>
    </div>

     <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/lonchera4.jpg" alt=""> 
      </div>
    </div>

    <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/lonchera5.jpg" alt=""> 
      </div>
    </div>

     <div class="col-md-4">
      <div class="fondo1-producto">
    <img src="imagenes/lonchera6.jpg" alt=""> 
      </div>
    </div>
      ...
      <div class="fondo2-producto">
			<h2>LONCHERAS</h2>
			<h3>Presio:S/.18.00</h3>
			<p>Esta es nuestra galería de loncheras, en donde usted podrá optar por el modelo que guste y comprar. </p>
      <a class="btn btn-danger" href="carrito.php">Comprar</a>
